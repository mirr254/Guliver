...
public class CustomerLoginActivity extends AppCompatActivity  implements
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sign_out_button:
                signOut();
                break;
            case R.id.customer_call_office_button:
                Log.d(TAG, "Call office: Call office clicked");
                Intent callIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "+252616651266"));
